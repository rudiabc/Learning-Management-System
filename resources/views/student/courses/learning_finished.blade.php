...
<body class="font-poppins text-[#0A090B]">
    <section id="content">
            ...
            <div class="nav flex items-center w-full h-[92px] max-w-[1280px] mx-auto justify-between p-5">
                <div class="flex items-center gap-4">
                    <div class="w-[50px] h-[50px] flex shrink-0 overflow-hidden rounded-full">
                        <img src="{{Storage::url($courseExam->cover)}}" class="object-cover" alt="thumbnail">
                        {{-- <img src="{{Storage::url(Auth::user()->avatar)}}" class="object-cover" alt="thumbnail"> --}}
                    </div>
                    <div class="flex flex-col gap-[2px]">
                        <p class="font-bold text-lg">{{ $courseExam->name }}</p>
        ...
        <div class="finished flex flex-col gap-[40px] items-center justify-center mt-[120px] mb-[30px] w-full">
            ...
            <a href="{{ route('admin.learning.rapport.course_exam', $courseExam) }}" class="w-fit p-[14px_30px] bg-[#6436F1] rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center align-middle">View Test Result</a>
        </div>
    </section>
