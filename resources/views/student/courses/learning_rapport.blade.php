        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <a href="{{ route('admin.learning.index') }}" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">My Courses</a>
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center">
                            <div class="flex gap-[10px] items-center">
                                ...
                                <p class="font-semibold">{{ $correctAnswersCount }} dari {{ $totalQuestions }} pertanyaan benar</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="result flex flex-col gap-5 mx-[70px] w-[870px] mt-[30px]">
                    <div class="question-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                        <div class="flex flex-col gap-[6px]">
                            ...
                            <p class="font-bold text-xl">{{ $answer->questionexam->question }}</p>
                        </div>
