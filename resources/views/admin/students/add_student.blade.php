        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <a href="{{ route('admin.course_exams.show', $courseExam) }}" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Manage Courses</a>
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                <div class="flex items-center gap-6">
                    <div class="w-[150px] h-[150px] flex shrink-0 relative overflow-hidden">
                        <img src="{{Storage::url($courseExam->cover)}}" class="object-contain w-full h-full"
                            alt="icon">
                        <p
                            ...
                            {{ $courseExam->categoryexam->name }}</p>
                    </div>
            ...
            <form action="{{ route('admin.course_exam.course_student_exams.store', $courseExam) }}" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5" method="POST">
                @csrf
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div
                        ...
                        <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            <img src="{{asset('images/icons/sms.svg')}}" class="object-contain w-full h-full" alt="icon">
                        </div>
                        <input type="text"
                            class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
