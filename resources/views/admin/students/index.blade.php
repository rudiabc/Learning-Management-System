            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                <div class="flex gap-6 items-center">
                    <div class="w-[150px] h-[150px] flex shrink-0 relative overflow-hidden">
                        <img src="{{Storage::url($courseExam->cover)}}" class="w-full h-full object-contain" alt="icon">
                ...
                <div class="relative">
                    <a href="{{ route('admin.course_exam.course_student_exams.create', $courseExam) }}" class="h-[52px] p-[14px_30px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D]">Add Student</a>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-5 mt-2">
                    ...
                    <div class="student-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                        ...
                        @elseif($student->status == 'Belum Mengerjakan')
                            <div class="flex items-center gap-[14px]">
                                <p class="p-[6px_10px] rounded-[10px] bg-slate-500 font-bold text-xs text-white outline-slate-500 outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">Belum Mengerjakan</p>
                            </div>
                        @elseif($student->status == 'Tidak Lulus')
                            <div class="flex items-center gap-[14px]">
                                <p class="p-[6px_10px] rounded-[10px] bg-[#FD445E] font-bold text-xs text-white outline-[#FD445E] outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">Tidak Lulus</p>
                            </div>
