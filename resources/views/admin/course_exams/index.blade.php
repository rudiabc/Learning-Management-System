        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col px-5 mt-5">
                <div class="flex items-center justify-between w-full">
                    ...
                    <a href="{{ route('admin.course_exams.create') }}" class="h-[52px] p-[14px_20px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D]">Add New Course</a>
                </div>
            </div>
            <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                ...
                @forelse($course_exams as $course_exam)
                    <div class="flex justify-between pr-10 list-items flex-nowrap">
                        ...
                        <div class="flex shrink-0 w-[150px] items-center justify-center">
                            <p class="font-semibold">
                                {{ \Carbon\Carbon::parse($course_exam->created_at)->format('F j, Y') }}
                            </p>
                        </div>
                        ...
                        <div class="flex shrink-0 w-[120px] items-center">
                            <div class="relative h-[41px]">
                                <div class="menu-dropdown w-[120px] max-h-[41px] overflow-hidden absolute top-0 p-[10px_16px] bg-white flex flex-col gap-3 border border-[#EEEEEE] transition-all duration-300 hover:shadow-[0_10px_16px_0_#0A090B0D] rounded-[18px]">
                                    ...
                                    <a href="{{ route('admin.course_exams.show', $course_exam) }}" class="flex items-center justify-between w-full text-sm font-bold">
                                        Manage
                                    </a>
                                    <a href="course-students.html" class="flex items-center justify-between w-full text-sm font-bold">
                                        Students
                                    </a>
                                    <a href="{{ route('admin.course_exams.edit', $course_exam) }}" class="flex items-center justify-between w-full text-sm font-bold">
                                        Edit Course
                                    </a>

                                    <form method="POST" action="{{ route('admin.course_exams.destroy', $course_exam) }}">
                                        @csrf
                                        @method('DELETE')
